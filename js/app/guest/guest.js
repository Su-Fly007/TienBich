...
import { mockConfigData } from "../../data/mock-config.js";
...
export const guest = (() => {
  ...
  const buildGoogleCalendar = () => {
    const calendarUrl = "https://calendar.google.com/calendar/u/0/share?slt=1AXs0gW0qMEO0CmhkNczJ-6eSbSNBfdeesu9qFIQAM8ns6xDj0xBJD-aYma2k8JOnFgI8pF1H1fEztQ";
    
    document
      .querySelector("#home button")
      ?.addEventListener("click", () => window.open(calendarUrl, "_blank"));
  };
  ...
  const pageLoaded = () => {
    ...
    // const params = new URLSearchParams(window.location.search); // Not needed with mock data
    ...
    if (token && token.length > 0) {
      ...
      Promise.resolve(mockConfigData)
        .then(({ data }) => {
